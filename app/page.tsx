...
const FEATURES = [
  ...
  { emoji:'🌍', title:'Built for GCC',     desc:'Full Arabic RTL interface and bilingual AI coaching. Content designed for GCC kids in Dubai, Riyadh, Doha, Kuwait City and Muscat.',                   color:'from-accent3/20 to-accent4/20', border:'border-accent3/20' },
    ...
    <div className="relative z-10 min-h-screen">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 flex items-center justify-between px-4 lg:px-12 py-3 md:py-4 glass border-b border-white/5">
        ...
        <div className="flex items-center gap-2 md:gap-3">
          {/* ── Sharkkid button — visible on all screen sizes ── */}
          <Link
            href="/sharkkid"
