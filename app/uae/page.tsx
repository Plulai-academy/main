    ...
    <>
          ...
          <div className={styles.heroGrid}>
            <div>
              ...
              <p className={styles.heroSub}>
                ...
                across the UAE (Dubai, Abu Dhabi, Sharjah), with in-person workshops available
            ...
            <div className={styles.heroVisual}>
              ...
              <div className={styles.floatBadge} style={{ bottom: 20, right: -20 }}>
                ...
                <div>
                  ...
                  <div className={styles.floatBadgeSub}>Dubai · Coding</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.schoolsGrid}>
            <div>
              ...
              <p style={{ color: 'rgba(41,57,74,0.7)', maxWidth: 460 }}>
                ...
                $70/month (approximately 257 AED).
              </p>
              <div className={styles.schoolsList}>
                <div className={styles.schoolsItem}>
                  <b>Learn anytime, anywhere in the UAE</b>
            ...
            <div>
              ...
              <div className={styles.schoolsList}>
                ...
                <div className={styles.schoolsItem}>
                  ...
                  <span>Built for the UAE classrooms, not translated from somewhere else.</span>
                </div>
                <div className={styles.schoolsItem}>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 800 }}>
          <h2 style={{ fontSize: 26, color: '#0D2B32', marginBottom: 16 }}>AI and Coding Education for Kids in the UAE</h2>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75, marginBottom: 20 }}>
            Parents across Dubai and Abu Dhabi are increasingly looking for a structured way for their kids to build real technical skills beyond what a normal school day covers — coding, AI literacy, and the kind of problem-solving that sticks. Plulai&apos;s self-paced format fits that: 15 minutes a day, on the family&apos;s own schedule, in Arabic or English.
          </p>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75 }}>
            For schools and training centers in the UAE, the same curriculum is available as a classroom-ready program — sessions built for a 30–45 minute class period, a teacher dashboard that flags who&apos;s falling behind, and onboarding support so teachers don&apos;t need a coding background themselves. We&apos;re actively building out school partnerships across the UAE; book a demo to talk specifics.
          </p>
        </div>
      </div>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 760 }}>
          <div className={styles.tracksHead}>
            ...
            <h2>Questions from families &amp; schools in the UAE</h2>
          </div>
      ...
      <div className={styles.finalCta}>
        <div className="container">
          <h2 className={styles.finalCtaTitle}>Ready to start in the UAE?</h2>
