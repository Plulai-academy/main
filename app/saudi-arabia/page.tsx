    ...
    <>
          ...
          <div className={styles.heroGrid}>
            <div>
              ...
              <p className={styles.heroSub}>
                ...
                across Saudi Arabia (Riyadh, Jeddah, Dammam), with in-person workshops available
            ...
            <div className={styles.heroVisual}>
              ...
              <div className={styles.floatBadge} style={{ bottom: 20, right: -20 }}>
                ...
                <div>
                  ...
                  <div className={styles.floatBadgeSub}>Riyadh · Coding</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.schoolsGrid}>
            <div>
              ...
              <p style={{ color: 'rgba(41,57,74,0.7)', maxWidth: 460 }}>
                ...
                $70/month (approximately 263 SAR).
              </p>
              <div className={styles.schoolsList}>
                <div className={styles.schoolsItem}>
                  <b>Learn anytime, anywhere in Saudi Arabia</b>
            ...
            <div>
              ...
              <div className={styles.schoolsList}>
                ...
                <div className={styles.schoolsItem}>
                  ...
                  <span>Built for Saudi Arabia classrooms, not translated from somewhere else.</span>
                </div>
                <div className={styles.schoolsItem}>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 800 }}>
          <h2 style={{ fontSize: 26, color: '#0D2B32', marginBottom: 16 }}>AI and Coding Education for Kids in Saudi Arabia</h2>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75, marginBottom: 20 }}>
            Families in Riyadh, Jeddah, and across Saudi Arabia are increasingly looking for a structured way for their kids to build real technical skills outside the standard school day — coding, AI literacy, and the kind of problem-solving a normal curriculum doesn&apos;t always have room for. Plulai&apos;s self-paced format fits that gap: 15 minutes a day, on the family&apos;s own schedule, in Arabic or English.
          </p>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75 }}>
            For schools and training centers in Saudi Arabia, the same curriculum is available as a classroom-ready program — sessions built for a 30–45 minute class period, a teacher dashboard that flags who&apos;s falling behind, and onboarding support so teachers don&apos;t need a coding background themselves. We&apos;re actively building out school partnerships in the Kingdom; book a demo to talk specifics.
          </p>
        </div>
      </div>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 760 }}>
          <div className={styles.tracksHead}>
            ...
            <h2>Questions from families &amp; schools in Saudi Arabia</h2>
          </div>
      ...
      <div className={styles.finalCta}>
        <div className="container">
          <h2 className={styles.finalCtaTitle}>Ready to start in Saudi Arabia?</h2>
