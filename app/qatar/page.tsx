...
export const metadata: Metadata = {
  title: 'Kids Coding & AI Classes in Qatar | Plulai',
  description: 'AI, coding, and entrepreneurship classes for kids ages 6-18 in Qatar. Self-paced online learning in Arabic or English, plus curriculum for schools in Doha and beyond.',
  alternates: { canonical: `${SITE_URL}/qatar` },
  openGraph: {
    title: 'Kids Coding & AI Classes in Qatar | Plulai',
    description: 'AI, coding, and entrepreneurship classes for kids ages 6-18 in Qatar. Self-paced online learning in Arabic or English, plus curriculum for schools in Doha and beyond.',
    url: `${SITE_URL}/qatar`,
...
function JsonLd() {
  ...
  const faqData = {
    '@context': 'https://schema.org',
    '@type': 'FAQPage',
    mainEntity: [{"@type": "Question", "name": "Is Plulai available in Doha and across Qatar?", "acceptedAnswer": {"@type": "Answer", "text": "Yes — the family plan is fully online, so it works anywhere in Qatar with an internet connection. For schools, we also offer in-person workshops on request."}}, {"@type": "Question", "name": "What languages are lessons taught in?", "acceptedAnswer": {"@type": "Answer", "text": "Arabic and English, taught natively — not machine-translated."}}, {"@type": "Question", "name": "How much does it cost?", "acceptedAnswer": {"@type": "Answer", "text": "Families get a 14-day free trial, then $70/month (approximately 255 QAR), billed in USD. School and training center pricing is scoped to seat count — book a demo for a quote."}}, {"@type": "Question", "name": "What ages is Plulai for?", "acceptedAnswer": {"@type": "Answer", "text": "Ages 6 to 18, with the curriculum adapted per age group."}}, {"@type": "Question", "name": "Do you work with schools and training centers in Qatar?", "acceptedAnswer": {"@type": "Answer", "text": "We are actively partnering with schools and training centers across the region. Book a demo to talk about your school specifically."}}],
  }
  return (
    <>
    ...
    <>
          ...
          <div className={styles.heroGrid}>
            <div>
              <div className={styles.statBadge}>
                ...
                Now serving families &amp; schools in Qatar
              </div>
              <h1 className={styles.heroTitle}>
                AI, Coding &amp; Entrepreneurship Classes for Kids in Qatar
              </h1>
              <p className={styles.heroSub}>
                15 minutes a day, taught in real Arabic or English — with
                an AI coach built around how kids actually learn. Available online
                across Qatar (Doha, Al Wakrah, Al Rayyan), with in-person workshops available
            ...
            <div className={styles.heroVisual}>
              ...
              <div className={styles.floatBadge} style={{ bottom: 20, right: -20 }}>
                ...
                <div>
                  ...
                  <div className={styles.floatBadgeSub}>Doha · Coding</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="pitch" className={styles.schoolsSec} style={{ scrollMarginTop: 90 }}>
        <div className="container">
          <div className={styles.schoolsGrid}>
            <div>
              <span className="pill">For Families in Qatar</span>
              ...
              <p style={{ color: 'rgba(41,57,74,0.7)', maxWidth: 460 }}>
                ...
                in Arabic or English. A 14-day free trial, then
                $70/month (approximately 255 QAR).
              </p>
              <div className={styles.schoolsList}>
                <div className={styles.schoolsItem}>
                  <b>Learn anytime, anywhere in Qatar</b>
            ...
            <div>
              ...
              <div className={styles.schoolsList}>
                ...
                <div className={styles.schoolsItem}>
                  ...
                  <span>Built for Qatar classrooms, not translated from somewhere else.</span>
                </div>
                <div className={styles.schoolsItem}>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 800 }}>
          <h2 style={{ fontSize: 26, color: '#0D2B32', marginBottom: 16 }}>AI and Coding Education for Kids in Qatar</h2>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75, marginBottom: 20 }}>
            More families in Doha and across Qatar are looking for a structured way for their kids to build real technical skills outside the standard school day — not just screen time, but coding, AI literacy, and the kind of problem-solving that a normal curriculum doesn&apos;t always have room for. Plulai&apos;s self-paced format fits that gap: 15 minutes a day, on the family&apos;s own schedule, in Arabic or English.
          </p>
          <p style={{ color: 'rgba(41,57,74,0.75)', lineHeight: 1.75 }}>
            For schools and training centers in Qatar, the same curriculum is available as a classroom-ready program — sessions built for a 30–45 minute class period, a teacher dashboard that flags who&apos;s falling behind, and onboarding support so teachers don&apos;t need a coding background themselves. We&apos;re actively building out school partnerships in Qatar; book a demo to talk specifics.
          </p>
        </div>
      </div>
      ...
      <div className={styles.tracksSec}>
        <div className="container" style={{ maxWidth: 760 }}>
          <div className={styles.tracksHead}>
            ...
            <h2>Questions from families &amp; schools in Qatar</h2>
          </div>
          <div style={{ marginTop: 40, display: 'flex', flexDirection: 'column', gap: 12 }}>
            <details style={{ border: '1px solid #E4E9E7', borderRadius: 14, background: '#fff', padding: '4px 20px' }}>
              <summary style={{ padding: '14px 0', fontSize: 15, fontWeight: 600, color: '#0D2B32', cursor: 'pointer' }}>Is Plulai available in Doha and across Qatar?</summary>
              <p style={{ margin: 0, padding: '0 0 18px', fontSize: 14, lineHeight: 1.6, color: 'rgba(41,57,74,0.7)' }}>Yes — the family plan is fully online, so it works anywhere in Qatar with an internet connection. For schools, we also offer in-person workshops on request.</p>
            </details>
            <details style={{ border: '1px solid #E4E9E7', borderRadius: 14, background: '#fff', padding: '4px 20px' }}>
              ...
              <p style={{ margin: 0, padding: '0 0 18px', fontSize: 14, lineHeight: 1.6, color: 'rgba(41,57,74,0.7)' }}>Arabic and English, taught natively — not machine-translated.</p>
            </details>
            <details style={{ border: '1px solid #E4E9E7', borderRadius: 14, background: '#fff', padding: '4px 20px' }}>
              <summary style={{ padding: '14px 0', fontSize: 15, fontWeight: 600, color: '#0D2B32', cursor: 'pointer' }}>How much does it cost?</summary>
              <p style={{ margin: 0, padding: '0 0 18px', fontSize: 14, lineHeight: 1.6, color: 'rgba(41,57,74,0.7)' }}>Families get a 14-day free trial, then $70/month (approximately 255 QAR), billed in USD. School and training center pricing is scoped to seat count — book a demo for a quote.</p>
            </details>
            <details style={{ border: '1px solid #E4E9E7', borderRadius: 14, background: '#fff', padding: '4px 20px' }}>
            ...
            <details style={{ border: '1px solid #E4E9E7', borderRadius: 14, background: '#fff', padding: '4px 20px' }}>
              ...
              <p style={{ margin: 0, padding: '0 0 18px', fontSize: 14, lineHeight: 1.6, color: 'rgba(41,57,74,0.7)' }}>We are actively partnering with schools and training centers across the region. Book a demo to talk about your school specifically.</p>
            </details>
          </div>
        </div>
      </div>
      ...
      <div className={styles.finalCta}>
        <div className="container">
          <h2 className={styles.finalCtaTitle}>Ready to start in Qatar?</h2>
